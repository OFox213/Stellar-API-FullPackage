...
#### 단계 1: 의존성 업데이트
(⚠️The dependency update description below refers to the original stellar-api. If you need to use a modified build, please implement it by each file at the top.)
